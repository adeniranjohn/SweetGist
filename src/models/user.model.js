...
UserSchema.methods.generateToken = function() {
    const token = jwt.sign({_id: this._id, email: this.email}, process.env.SECRET ,{expiresIn: '1h'});
    return token;
}
...
module.exports =  mongoose.models.User || mongoose.model('Member', UserSchema);